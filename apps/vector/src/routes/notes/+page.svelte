...
<section class="container mx-auto py-5">
	...
	{:else if notes.length === 0 && !showLegacy}
		<p class="mt-6 text-sm">You don't have any training notes yet.</p>
	{:else}
		{#if notes.length === 0 && showLegacy}
			<p class="mt-6 text-sm opacity-70">You don't have any Vector training notes yet.</p>
		{:else}
