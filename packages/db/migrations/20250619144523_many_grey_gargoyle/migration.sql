...
DROP INDEX IF EXISTS "integrations_cid_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "integrations_type_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "integrations_integrationUserId_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "integrations_cid_type_unique";--> statement-breakpoint
ALTER TABLE `ticket_messages` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT 1750344323435;--> statement-breakpoint
...
ALTER TABLE `tickets` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT 1750344323435;--> statement-breakpoint
ALTER TABLE `solo_endorsements` ALTER COLUMN "expires_at" TO "expires_at" integer NOT NULL DEFAULT '"2025-07-19T14:45:23.387Z"';--> statement-breakpoint
ALTER TABLE `integrations` ADD `integration_user_name` text;