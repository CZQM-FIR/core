...
-- REMOVED: DROP INDEX "online_sessions_userId_idx"; (doesn't exist)
-- REMOVED: DROP INDEX "online_sessions_positionId_idx"; (doesn't exist)
-- REMOVED: DROP INDEX "online_sessions_start_idx"; (doesn't exist)
ALTER TABLE `ticket_messages` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT 1759020811662;--> statement-breakpoint
...
CREATE INDEX `online_sessions_userId_idx` ON `online_sessions` (`userId`);--> statement-breakpoint
...
ALTER TABLE `tickets` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT 1759020811662;--> statement-breakpoint
ALTER TABLE `solo_endorsements` ALTER COLUMN "expires_at" TO "expires_at" integer NOT NULL DEFAULT '"2025-10-28T00:53:31.634Z"';--> statement-breakpoint
ALTER TABLE `online_sessions` ALTER COLUMN "start" TO "start" integer NOT NULL;