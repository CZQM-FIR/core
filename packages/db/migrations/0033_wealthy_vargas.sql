...
DROP INDEX "preferences_cid_key_unique";--> statement-breakpoint
DROP INDEX "waiting_users_cid_idx";--> statement-breakpoint
DROP INDEX "waiting_users_waitlistId_idx";--> statement-breakpoint
DROP INDEX "waiting_users_position_idx";--> statement-breakpoint
DROP INDEX "waiting_users_waitingSince_idx";--> statement-breakpoint
ALTER TABLE `waiting_users` ALTER COLUMN "position" TO "position" integer NOT NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX `preferences_cid_key_unique` ON `preferences` (`cid`,`key`);--> statement-breakpoint
...
ALTER TABLE `waiting_users` DROP COLUMN `enrolled_at`;