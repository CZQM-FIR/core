CREATE TABLE `online_sessions` (
	...
	`start` integer DEFAULT '"1970-01-01T00:00:00.000Z"' NOT NULL,
...
DROP INDEX "online_sessions_userId_idx";--> statement-breakpoint
DROP INDEX "online_sessions_positionId_idx";--> statement-breakpoint
DROP INDEX "online_sessions_start_idx";--> statement-breakpoint
ALTER TABLE `ticket_messages` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT 1759011924904;--> statement-breakpoint
...
ALTER TABLE `tickets` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT 1759011924904;--> statement-breakpoint
ALTER TABLE `solo_endorsements` ALTER COLUMN "expires_at" TO "expires_at" integer NOT NULL DEFAULT '"2025-10-27T22:25:24.861Z"';